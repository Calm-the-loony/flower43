    ...
    <header className={`header ${scrolled ? 'scrolled' : ''}`}>
      <div className="header__container">
        ...
        <nav className={`header__nav ${menuOpen ? 'open' : ''}`}>
          <Link to="/" className="nav__link" onClick={() => setMenuOpen(false)}>Главная</Link>
          <Link to="/bouquets" className="nav__link" onClick={() => setMenuOpen(false)}>Букеты</Link>
          <Link to="/plants" className="nav__link" onClick={() => setMenuOpen(false)}>Растения</Link>
          <Link to="/compositions" className="nav__link" onClick={() => setMenuOpen(false)}>Композиции</Link>
          <Link to="/about" className="nav__link" onClick={() => setMenuOpen(false)}>О нас</Link>
          <Link to="/delivery" className="nav__link" onClick={() => setMenuOpen(false)}>Доставка</Link>
          
          <div className="nav__icons">
            <Link to="/favorites" className="icon__button" onClick={() => setMenuOpen(false)}>
            ...
            <Link to="/cart" className="icon__button" onClick={() => setMenuOpen(false)}>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor">
